<?php
/**
 * Project Data Adapter for Molajito
 *
 * @package    Project
...
/**
 * Project Example Data Adapter for Molajito
 *
 * @package    Project
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2014 Amy Stephen. All rights reserved.
 * @since      1.0.0
 */
class Project extends AbstractAdapter implements DataInterface
{
    /**
     * Runtime Data
     *
    ...
    public function __construct(
        ...
        if (isset($options['data_folder'])) {
            $this->loadItems($options['data_folder']);
    ...
    protected function initialise($token, array $options = array())
    {
        ...
        if ($this->first_request === true) {
            ...
            $this->setItemURLs($blog_breadcrumbs);
        }
    ...
    protected function getMenu()
    {
        ...
        $this->query_results[] = $this->setListRow($this->runtime_data->route->browse, 'Browse');
    ...
    protected function getPagination()
    {
        ...
        $other_query_parameters['page'] = 'browse';
    ...
    protected function getItems()
    {
        ...
        $display_items_per_page_count  = $this->setPaginationItemsPerPage();
        ...
        /** Parameter Array */
        $parameter_array = $this->setItemSelectionCriteria();
     ...
     * @since   1.0
     */
    protected function setPaginationItemsPerPage()
    {
     ...
     * @throws  \CommonApi\Exception\RuntimeException
     */
    protected function setItemSelectionCriteria()
    {
        /** Parameter Array */
     ...
     * @throws  \CommonApi\Exception\RuntimeException
     */
    protected function setItemURLs($blog_breadcrumbs)
    {
        $home = $this->runtime_data->route->home;
     ...
     * @since   1.0
     */
    protected function loadItems($data_folder)
    {
