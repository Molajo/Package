...
$runtime_data->parameters->site_title                      = 'Molajo Project';
$runtime_data->parameters->display_items_per_page_count    = 30;
$runtime_data->parameters->display_page_link_count         = 10;
...
$runtime_data->route->browse                                 = $page_url . '/index.php?page=browse';
$runtime_data->route->browse_text                            = 'Browse';
